...
# 36 "../../../../Library/StdDriver/src/sys.c"
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->RSTSTS = u32Src;
}
# 48 "../../../../Library/StdDriver/src/sys.c"
uint32_t SYS_GetBODStatus(void)
{
    return ((((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & (0x1ul << (6))) >> (6));
}
...
uint32_t SYS_GetResetSrc(void)
{
    return (((SYS_T *) ((0x40000000UL) + 0x00000UL))->RSTSTS);
}
# 71 "../../../../Library/StdDriver/src/sys.c"
uint32_t SYS_IsRegLocked(void)
{
    return ((SYS_T *) ((0x40000000UL) + 0x00000UL))->REGLCTL & 1UL ? 0UL : 1UL;
}
...
uint32_t SYS_ReadPDID(void)
{
    return ((SYS_T *) ((0x40000000UL) + 0x00000UL))->PDID;
}
# 94 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetChip(void)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (0));
}
# 106 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetCPU(void)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (1));
}
# 169 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
    ...
    u32TmpAddr = (uint32_t)&((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST0 + ((u32ModuleIndex >> 24UL));
...
# 202 "../../../../Library/StdDriver/src/sys.c"
int32_t SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{



    do{ uint32_t u32TimeOutCnt = SystemCoreClock; while(((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) { if(--u32TimeOutCnt == 0) break; } }while(0);

    if( (((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) == 0 )
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & ~((0x1ul << (3)) | (0x7ul << (16)))) | ((uint32_t)i32Mode) | (u32BODLevel) | ((0x1ul << (0)));

    else return (-2L);

    return ( 0L);
}
# 225 "../../../../Library/StdDriver/src/sys.c"
int32_t SYS_DisableBOD(void)
{
    do{ uint32_t u32TimeOutCnt = SystemCoreClock; while(((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) { if(--u32TimeOutCnt == 0) break; } }while(0);

    if( (((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & (0x1ul << (31))) == 0 )
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL &= ~(0x1ul << (0));
    else return (-2L);
...
int32_t SYS_SetPowerLevel(uint32_t u32PowerLevel)
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLCTL = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLCTL & (~(0x3ul << (0)))) | (u32PowerLevel);
...
# 286 "../../../../Library/StdDriver/src/sys.c"
int32_t SYS_SetPowerRegulator(uint32_t u32PowerRegulator)
{
    ...
    u32PowerRegStatus = ((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (12));


    if((u32PowerRegulator == (0x1UL<<(4))) && (u32PowerRegStatus == (0x0UL<<(12))))
    {

        i32TimeOutCnt = SystemCoreClock;
        while(((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLCTL & (0x1ul << (7)))
        {
            if(i32TimeOutCnt-- <= 0) return (-2L);
        }
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLCTL |= (0x1ul << (4));


        i32TimeOutCnt = SystemCoreClock;
        while(((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (1)))
        {
            if(i32TimeOutCnt-- <= 0) return (-2L);
        }
        if((((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (12))) != (0x1UL<<(12)))
        {
            u32Ret = 0U;
        }
    }
    else if(u32PowerRegulator == (0x0UL<<(4)))
    {
        ...
        if((((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (12))) != (0x0UL<<(12)))
        {
            u32Ret = 0U;
        }
    }
    ...
    if(((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (2)))
    {
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS = (0x1ul << (2));
        u32Ret = 0U;
    }

    return u32Ret;
}
# 383 "../../../../Library/StdDriver/src/sys.c"
int32_t SYS_SetSSRAMPowerMode(uint32_t u32SRAMSel, uint32_t u32PowerMode)
{
    ...
    if(u32PowerMode & 0x80000000UL)
    {
        u32TimeOutCnt = SystemCoreClock;
        while(((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPC1 & (0x1ul << (31)))
        {
            if(--u32TimeOutCnt == 0) return -1;
        }
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPC1 = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPC1 & (~u32SRAMSel)) | (u32PowerMode << u32SRAMSelPos);
    }
    else
    {
        u32TimeOutCnt = SystemCoreClock;
        while(((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPC0 & (0x1ul << (31)))
        {
            if(--u32TimeOutCnt == 0) return -1;
        }
        ((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPC0 = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPC0 & (~u32SRAMSel)) | (u32PowerMode << u32SRAMSelPos);
    }

    return 0;
}
# 443 "../../../../Library/StdDriver/src/sys.c"
int32_t SYS_SetPSRAMPowerMode(uint32_t u32SRAMSel, uint32_t u32PowerMode)
{
...
# 484 "../../../../Library/StdDriver/src/sys.c"
void SYS_SetVRef(uint32_t u32VRefCTL)
{

    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->VREFCTL = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->VREFCTL & (~(0x1ful << (0)))) | (u32VRefCTL);
}
