...
# 49 "../../../../Library/StdDriver/src/retarget.c"
FILE __stdout;
FILE __stdin;
...
# 110 "../../../../Library/StdDriver/src/retarget.c"
...
# 248 "../../../../Library/StdDriver/src/retarget.c"
...
# 307 "../../../../Library/StdDriver/src/retarget.c"
    ...
    else if((inst >> 12) == 5)
    {
        ...
        printf("[0x%08x] 0x%04x %s 0x%x [0x%x]\n", addr, inst,
               (inst & 0x00000800UL) ? "LDR" : "STR", tdata, taddr);
    ...
    u32Reg = ((SCU_T *) ((0x40000000UL) + 0x2F000UL))->PVINTSTS;
    if(u32Reg)
    {
        ...
        for(i = 0; i < sizeof(ipname); i++)
        {
            if(u32Reg & (1 << i))
            {
                printf("%s(0x%08x) Violation! ", ipname[i], (*((vu32 *) (((0x40000000UL) + 0x2F000UL) + info[i] + 4))));
                printf("Caused by %s\n", master[(*((vu32 *) (((0x40000000UL) + 0x2F000UL) + (uint32_t)info[i])))]);
                break;
            }
        }
    }
...
# 436 "../../../../Library/StdDriver/src/retarget.c"
void SendChar_ToUART(int ch)
{
    if((char)ch == '\n')
    {
        while(((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (23))) {}
        ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->DAT = '\r';
    }

    while(((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (23))) {}
    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->DAT = (uint32_t)ch;
}
# 515 "../../../../Library/StdDriver/src/retarget.c"
void SendChar(int ch)
{
...
# 559 "../../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 597 "../../../../Library/StdDriver/src/retarget.c"
    while(1)
    {
        if((((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (14))) == 0U)
        {
            return ((char)((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->DAT);
        }
    }


}
# 619 "../../../../Library/StdDriver/src/retarget.c"
int kbhit(void)
{
    return !((((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (14))) == 0U);
}
# 634 "../../../../Library/StdDriver/src/retarget.c"
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (28))) != 0U);
}
# 649 "../../../../Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 674 "../../../../Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    (void)stream;
    SendChar(ch);
...
# 727 "../../../../Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    (void)stream;
    return ((int)GetChar());
}
# 748 "../../../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    (void)stream;
    return (-1);
