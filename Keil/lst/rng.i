# 1 "../../../../Library/StdDriver/src/rng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/rng.c" 2
# 10 "../../../../Library/StdDriver/src/rng.c"
...
# 11 "../../../../Library/StdDriver/src/rng.c" 2
...
# 12 "../../../../Library/StdDriver/src/rng.c" 2
# 26 "../../../../Library/StdDriver/src/rng.c"
...
# 52 "../../../../Library/StdDriver/src/rng.c"
int32_t RNG_Open(void)
{
    int32_t i;
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->AHBCLK |= (0x1ul << (12));
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->APBCLK1 |= (0x1ul << (25));
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->APBCLK0 |= (0x1ul << (1));

    ((RTC_T *) (((0x40000000UL) + 0x00040000UL) + 0x01000UL))->LXTCTL |= ((0x1ul << (6)) | (0x1ul << (0)));

    ((TRNG_T *)(((0x40000000UL) + 0x00040000UL) + 0x79000UL))->ACT |= (0x1ul << (7));

    i = 0;
    while((((TRNG_T *)(((0x40000000UL) + 0x00040000UL) + 0x79000UL))->CTL & (0x1ul << (7))) == 0)
    {
        if(i++ > timeout)
        {
    ...
    ((TRNG_T *)(((0x40000000UL) + 0x00040000UL) + 0x79000UL))->CTL = (0 << (2));



    ((TRNG_T *)(((0x40000000UL) + 0x00040000UL) + 0x79000UL))->CTL |= (1 << 8);


    i = 0;
    while((((TRNG_T *)(((0x40000000UL) + 0x00040000UL) + 0x79000UL))->CTL & (1 << 9)) == 0)
    {
        if(i++ > timeout)
        {
    ...
    i = 0;
    while(((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL & (1 << 8))
    {
        if(i++ > timeout)
        {
    ...
    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL = (0x1ul << (6));


    i = 0;
    while((((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL & (0x1ul << (7))) == 0)
    {
        if(i++ > timeout)
        {
    ...
    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL |= (( 6UL) << (2)) | (0x1ul << (0)) | (0x1ul << (1));

    i = 0;
    while(((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL & (0x1ul << (8)))
    {
        if(i++ > timeout)
        {
...
# 146 "../../../../Library/StdDriver/src/rng.c"
int32_t RNG_Random(uint32_t *pu32Buf, int32_t nWords)
{
    int32_t i;
    ...
    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL = (6 << (2)) | (0x1ul << (0));
    ...
    for(i = 0; i < nWords; i++)
    {
        pu32Buf[i] = ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_KEY[i];
    }

    return nWords;
}
# 194 "../../../../Library/StdDriver/src/rng.c"
int32_t RNG_ECDSA_Init(uint32_t u32KeySize, uint32_t au32ECC_N[18])
{
    int32_t i;
    int32_t timeout = 0x1000000;
    ...
    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL = 0;



    ((TRNG_T *)(((0x40000000UL) + 0x00040000UL) + 0x79000UL))->CTL |= (0x1ul << (8));


    i = 0;
    while((((TRNG_T *)(((0x40000000UL) + 0x00040000UL) + 0x79000UL))->CTL & (0x1ul << (9))) == 0)
    {
        if(i++ > timeout)
        {
            return -1;
    ...
    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL = 1 << (6);
    ...
    for(i = 0; i < 18; i++)
        ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->ECC_N[i] = au32ECC_N[i];

    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_KSCTL = 0;


    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL |= (u32KeySize << (2)) |
                      (0x1ul << (0)) | (0x1ul << (1));
    ...
    ((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_KSCTL = ((4ul) << (24)) |
                       (0x1ul << (20)) |
                       ((0x1ul << (21))) |
                       (KS_SRAM << (22));
...
# 299 "../../../../Library/StdDriver/src/rng.c"
int32_t RNG_ECDSA(uint32_t u32KeySize)
{
    int32_t timeout;
    int32_t i;
    ...
    if(((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_KSSTS & (0x1ul << (16)))
    {

        return -1;
    }

    return (((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_KSSTS & (0x1ful << (0)));
}
# 344 "../../../../Library/StdDriver/src/rng.c"
int32_t RNG_ECDH_Init(uint32_t u32KeySize, uint32_t au32ECC_N[18])
{
    int32_t i;
    int32_t timeout = 0x1000000;
    ...
    i = 0;
    while((((CRPT_T *) ((0x40000000UL) + 0x32000UL))->PRNG_CTL & (1 << 7)) == 0)
    {
        if(i++ > timeout)
        {
...
# 451 "../../../../Library/StdDriver/src/rng.c"
int32_t RNG_ECDH(uint32_t u32KeySize)
{
    int32_t timeout;
    int32_t i;
