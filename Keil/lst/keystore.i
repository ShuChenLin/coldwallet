# 1 "../../../../Library/StdDriver/src/keystore.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/keystore.c" 2
...
# 10 "../../../../Library/StdDriver/src/keystore.c" 2
# 29 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_Open(void)
{
    uint32_t u32TimeOutCount;

    if((((KS_T *)((0x40000000UL) + 0x35000UL))->STS & (0x1ul << (7))) == 0)
    {

        u32TimeOutCount = (SystemCoreClock);
        while(((KS_T *)((0x40000000UL) + 0x35000UL))->STS & (0x1ul << (2)))
        {
        ...
        ((KS_T *)((0x40000000UL) + 0x35000UL))->CTL = (0x1ul << (8)) | (0x1ul << (0));


        u32TimeOutCount = (SystemCoreClock);
        while((((KS_T *)((0x40000000UL) + 0x35000UL))->STS & (0x1ul << (7))) == 0)
        {
            if(--u32TimeOutCount == 0)
            {
                return (-2L);
...
# 87 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_Read(KS_MEM_Type eType, int32_t i32KeyIdx, uint32_t au32Key[], uint32_t u32WordCnt)
{
    ...
    if(((KS_T *)((0x40000000UL) + 0x35000UL))->STS & (0x1ul << (2)))
        return -1;


    ((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA = ((uint32_t)eType << (30)) | (((uint32_t)(i32KeyIdx) << (20)) & (0x3ful << (20)));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->STS = (0x1ul << (1));
    offset = 0;
    u32Cont = 0;
    ...
    do
    {
        ...
        ((KS_T *)((0x40000000UL) + 0x35000UL))->STS = (0x1ul << (1)) | (0x1ul << (0));


        ((KS_T *)((0x40000000UL) + 0x35000UL))->CTL = u32Cont | (0 << (1)) | (0x1ul << (0)) | (((KS_T *)((0x40000000UL) + 0x35000UL))->CTL & ((0x1ul << (10)) | (0x1ul << (11))));
        ...
        for(i = 0; i < cnt; i++)
        {
            au32Key[offset + i] = ((KS_T *)((0x40000000UL) + 0x35000UL))->KEY[i];
    ...
    if(((KS_T *)((0x40000000UL) + 0x35000UL))->STS & (0x1ul << (1)))
        return -1;


    return 0;
}
# 169 "../../../../Library/StdDriver/src/keystore.c"
uint32_t KS_GetKeyWordCnt(uint32_t u32Meta)
{
    const uint16_t au8CntTbl[21] = { 4, 6, 6, 7, 8, 8, 8, 9, 12, 13, 16, 17, 18, 0, 0, 0, 32, 48, 64, 96, 128 };
    return au8CntTbl[((u32Meta & (0x1ful << (8))) >> (8))];
}
# 216 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_Write(KS_MEM_Type eType, uint32_t u32Meta, uint32_t au32Key[])
{
    int32_t i32Cnt;
    uint32_t u32Cont;
    ...
    ((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA = (eType << (30)) | u32Meta;
    ...
    do
    {
        ...
        for(i = 0; i < cnt; i++)
        {
            ((KS_T *)((0x40000000UL) + 0x35000UL))->KEY[i] = au32Key[offset + i];
        }
        ...
        ((KS_T *)((0x40000000UL) + 0x35000UL))->CTL = u32Cont | (1 << (1)) | (0x1ul << (0)) | (((KS_T *)((0x40000000UL) + 0x35000UL))->CTL & ((0x1ul << (10)) | (0x1ul << (11))));
    ...
    return (((uint32_t)(((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA) & (0x3ful << (20))) >> (20));
}
# 295 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_EraseKey(int32_t i32KeyIdx)
{
    uint32_t u32TimeOutCount = (SystemCoreClock);
    ...
    ((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA = (KS_SRAM << (30)) | (((uint32_t)(i32KeyIdx) << (20)) & (0x3ful << (20)));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->STS = (0x1ul << (1)) | (0x1ul << (0));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->CTL = (2 << (1)) | (0x1ul << (0)) | (((KS_T *)((0x40000000UL) + 0x35000UL))->CTL & ((0x1ul << (10)) | (0x1ul << (11))));
...
# 342 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_EraseAll(KS_MEM_Type eType)
{
    uint32_t u32TimeOutCount = (SystemCoreClock);
    ...
    ((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA = (eType << (30));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->STS = (0x1ul << (1)) | (0x1ul << (0));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->CTL = (3 << (1)) | (0x1ul << (0)) | (((KS_T *)((0x40000000UL) + 0x35000UL))->CTL & ((0x1ul << (10)) | (0x1ul << (11))));
...
# 390 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_RevokeKey(KS_MEM_Type eType, int32_t i32KeyIdx)
{
    uint32_t u32TimeOutCount = (SystemCoreClock);
    ...
    ((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA = (eType << (30)) | (((uint32_t)(i32KeyIdx) << (20)) & (0x3ful << (20)));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->STS = (0x1ul << (1)) | (0x1ul << (0));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->CTL = (4 << (1)) | (0x1ul << (0)) | (((KS_T *)((0x40000000UL) + 0x35000UL))->CTL & ((0x1ul << (10)) | (0x1ul << (11))));
...
# 434 "../../../../Library/StdDriver/src/keystore.c"
uint32_t KS_GetRemainSize(KS_MEM_Type mem)
{
    uint32_t u32Reg;
    uint32_t u32SramRemain, u32FlashRemain;

    u32Reg = ((KS_T *)((0x40000000UL) + 0x35000UL))->REMAIN;


    u32SramRemain = (u32Reg & (0x1ffful << (0))) >> (0);
    u32FlashRemain = (u32Reg & (0xffful << (16))) >> (16);
...
# 461 "../../../../Library/StdDriver/src/keystore.c"
uint32_t KS_GetRemainKeyCount(KS_MEM_Type mem)
{
    uint32_t u32Reg;
    uint32_t u32SramRemain, u32FlashRemain;

    u32Reg = ((KS_T *)((0x40000000UL) + 0x35000UL))->REMKCNT;
    u32SramRemain = (u32Reg & (0x3ful << (0))) >> (0);
    u32FlashRemain = (u32Reg & (0x3ful << (16))) >> (16);
...
# 509 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_WriteOTP(int32_t i32KeyIdx, uint32_t u32Meta, uint32_t au32Key[])
{
    ...
    ((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA = ((uint32_t)KS_OTP << (30)) | u32Meta | (((uint32_t)(i32KeyIdx) << (20)) & (0x3ful << (20)));


    sidx = (u32Meta >> (8)) & 0xful;
...
# 589 "../../../../Library/StdDriver/src/keystore.c"
int32_t KS_ToggleSRAM(void)
{
    uint32_t u32TimeOutCount = (SystemCoreClock);
    ...
    ((KS_T *)((0x40000000UL) + 0x35000UL))->METADATA = ((uint32_t)KS_SRAM << (30));


    ((KS_T *)((0x40000000UL) + 0x35000UL))->STS = (0x1ul << (1)) | (0x1ul << (0));

    ((KS_T *)((0x40000000UL) + 0x35000UL))->CTL = (5 << (1)) | (0x1ul << (0));
    ...
    return ((((KS_T *)((0x40000000UL) + 0x35000UL))->STS & (0x1ul << (8))) > 0);
}
